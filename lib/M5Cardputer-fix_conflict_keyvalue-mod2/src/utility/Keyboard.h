...
const KeyValue_t _key_value_map[4][14] = {{{'`', '~'},
                                           ...
                                           {'-', '_'},
                                           {'=', '+'},
                                           {M5_KEY_BACKSPACE, M5_KEY_BACKSPACE}},
                                          {{M5_KEY_TAB, M5_KEY_TAB},
                                           {'q', 'Q'},
                                           {'w', 'W'},
                                           {'e', 'E'},
                                           {'r', 'R'},
                                           ...
                                           {'\\', '|'}},
                                          {{M5_KEY_FN, M5_KEY_FN},
                                           {M5_KEY_LEFT_SHIFT, M5_KEY_LEFT_SHIFT},
                                           {'a', 'A'},
                                           {'s', 'S'},
                                           {'d', 'D'},
                                           {'f', 'F'},
                                           ...
                                           {';', ':'},
                                           {'\'', '\"'},
                                           {M5_KEY_ENTER, M5_KEY_ENTER}},
                                          {{M5_KEY_LEFT_CTRL, M5_KEY_LEFT_CTRL},
                                           {M5_KEY_OPT, M5_KEY_OPT},
                                           {M5_KEY_LEFT_ALT, M5_KEY_LEFT_ALT},
                                           {'z', 'Z'},
                                           {'x', 'X'},
                                           {'c', 'C'},
                                           {'v', 'V'},
